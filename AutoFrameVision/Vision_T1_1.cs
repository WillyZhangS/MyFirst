...
namespace AutoFrameVision
{
    ...
    /// 视觉处理步骤样板类
    /// </summary>
    public class Vision_T1_1:VisionBase
    {
        ...
        public Vision_T1_1(string strName):base(strName)
        {
        ...
        public override bool LoadParam()
        {
            ...
            string strTemp = IniOperation.GetStringValue(strFile, "T1_1", "ExposureTime", null);
        ...
        public override bool SaveParam()
        {
            ...
            IniOperation.WriteValue(strFile, "T1_1", "ExposureTime", m_ExposureTime.ToString());
        ...
        public override bool ProcessImage( VisionControl vc)
        {
            ...
            {
                HTuple data=0;
                hde.T1_1(imgSrc, m_strDir, ModelId, ModelData, out data);
                if (data[0] == 1)
                {
