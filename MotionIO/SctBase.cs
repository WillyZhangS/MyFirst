...
namespace MotionIO
{
    ...
    public class SctBase
    {
        ...
        [DllImport("M400DLL.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int SCT_GetErrorStatus(int CardNo, ref int AxesError);
        ...
        [DllImport("M400DLL.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int SCT_WaitFifoEmpty(int CardNo, int TimeOver);
