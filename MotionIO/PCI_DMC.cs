...
namespace PCI_DMC
{
   ...
   //     [DllImport("PCI_DMC.dll", EntryPoint = "_DMC_01_set_gear2")]
    //    public static extern short CS_DMC_01_set_gear2(ushort CardNo, ushort NodeID, ushort SlotID, double numerator, double denominator, ushort Enable);
        ...
        public static extern short CS_DMC_01_set_rm_04pi_md2_feedback_mode(ushort CardNo, ushort NodeID, ushort SlotID, ushort mode);//mode 0:With feedback 1:Without feedback
	...
	[DllImport("PCI_DMC.dll", EntryPoint = "_DMC_01_get_dio_output_DW")]
        public unsafe static extern short CS_DMC_01_get_dio_output_DW(ushort CardNo, ref uint *On_Off);
	[DllImport("PCI_DMC.dll", EntryPoint = "_DMC_01_get_dio_input_DW")]
        public unsafe static extern short CS_DMC_01_get_dio_input_DW(ushort CardNo, ref uint *On_Off);
